...
| 提案 | 説明 |
|-----------|--------------|
|Yearn改善プロポーザル (YIP)|YFIホルダーに委任された権限、または議会の権限の範囲外の権限を実行する提案|
|Yearnデリゲーションプロポーザル(YDP)|個別の意思決定権の委譲先を変更する提案|
|Yearnシグナリングプロポーザル(YSP)|何らかの問題に対するコミュニティの感情や意思を示すための拘束力のない提案|
