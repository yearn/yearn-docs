# Tôken của Vault (Kho bạc)

[Tôken yVault](https://docs.yearn.finance/resources/defi-glossary#ytoken) tương tự như chứng từ/biên lai ký gửi. Chúng đại diện cho phần của người dùng trong yVault đang tham gia.

**Ví dụ**, nếu ký gửi đồng YFI vào một yVault, bạn sẽ nhận lại yvYFI. yvYFI chính là Tôken của yVault này.

Nếu yVault đó tạo ra lợi nhuận, giá trị của phần tôken yVault của bạn sẽ tăng lên. Lý do: Giờ có nhiều tôken cơ sở hơn trong yVault để chuộc lại lúc rút.

![](https://i.imgur.com/OtK6kAA.png)
*Tôken yvYFI ở [Etherscan](https://etherscan.io/token/0xE14d13d8B3b85aF791b2AADD661cDBd5E6097Db1#readContract); trên hình hiển thị tổng tài sản, giá trị mỗi phần và tên của nó.*

Sau khi thanh khoản của người dùng rút khỏi yVault, Tôken yVault tương ứng sẽ bị "đốt" bỏ. Tôken yVault thuộc chuẩn [ERC20](https://docs.ethhub.io/built-on-ethereum/erc-token-standards/erc20/), nghĩa là chúng có thể được di chuyển và mua bán như bất kỳ tôken thường thấy nào ở (chuỗi khối) Ethereum.

## Các Tôken của yVault V2

| Vault (Kho bạc) | Tôken đầu Vào | Tôken đầu Ra | 
| :--- | :--- | :--- | 
