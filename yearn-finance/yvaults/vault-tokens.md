...
[yVault Tokens](https://docs.yearn.finance/resources/defi-glossary#ytoken) sind wie eine Einzahlungsquittung. Sie repräsentieren den Anteil eines Nutzers an dem yVault, an dem er beteiligt ist.

Wenn du **zum Beispiel** YFI in einen yVault einzahlst, bekommst du dafür yvYFI. yvYFI wäre der yVault Token.

Wenn dein yVault Gewinn erwirtschaftet, wird der Kurs deiner yVault-Token steigen. Dies geschieht, weil es mehr zugrundeliegende Token im yVault gibt, die bei einer Entnahme eingelöst werden können.

![](https://i.imgur.com/OtK6kAA.png)

*Der yvYFI-Token bei [Etherscan](https://etherscan.io/token/0xE14d13d8B3b85aF791b2AADD661cDBd5E6097Db1#readContract), mit Angabe des Namens, des Gesamtvermögens und des Preises pro Aktie.*

Sobald die Liquidität eines Nutzers aus dem yVault abgezogen wird, wird sein yVault Token verbrannt. yVault Token sind [ERC20](https://docs.ethhub.io/built-on-ethereum/erc-token-standards/erc20/), d.h. sie können wie jeder andere Ethereum Token übertragen und gehandelt werden.

## V2 yVault-Tokens

| Vault | Eingabe-Token | Ausgabe-Token | 
| :--- | :--- | :--- | 
