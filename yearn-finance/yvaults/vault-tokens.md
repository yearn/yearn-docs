...
[Tokens yVault](https://docs.yearn.finance/resources/defi-glossary#ytoken) são como um comprovante de depósito. Eles representam a partição da yVault da qual o usuário está participando.

**Por exemplo**, se você depositar YFI em uma yVault, você receberá em retorno yvYFI. yvYFI é o token da yVault.
...
Uma vez que a liquidez de um usuário é retirada da yVault, o seu token yVault é destruído. Tokens yVault são [ERC20](https://docs.ethhub.io/built-on-ethereum/erc-token-standards/erc20/), o que significa que eles podem ser transferidos e trocados como qualquer outro token comum do Ethereum.

## Tokens yVault V2

| Vault | Token de Depósito | Token de Saída |
| :--- | :--- | :--- |
...
| crvTBTC | [Curve tBTC Pool yVault](https://etherscan.io/address/0x23D3D0f1c697247d5e0a9efB37d8b0ED0C464f7f) | [yvCurve-tBTC](https://etherscan.io/token/0x23D3D0f1c697247d5e0a9efB37d8b0ED0C464f7f) |
