# Contributing to a yearn Github repository
...
#### The first thing to do is to setup your environment and download the necessary software, which is usually listed in the README file of a github repository. See the repository for [Yearn V2 contract](https://github.com/iearn-finance/yearn-vaults/blob/master/README.md) for example. We will use it as an example in the remainder of this document.
...
**NOTE**: [commit messages of repositories like Yearn V2 must follow Conventional Commits standard](https://www.conventionalcommits.org/en/v1.0.0/), otherwise your pull requests (discussed further below below) will not pass validation tests. You can use the [`--amend` flag](https://git-scm.com/docs/git-commit) to effectively change your commit message.
