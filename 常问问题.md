...
如果您有任何問題或者发现了任何系統漏洞，请以下面的方式联系我们：

- [Github](https://github.com/iearn-finance) - 在相关代码库中新增的问题
- [Forum](https://gov.yearn.finance/c/feedback/) - 在反馈栏中的說明
...
- 比起手动操作每个合约，Zap 一站式操作合约可能会消耗更多的 gas 费，但是如果你的交易量大而且为了节约时间快速兑换即为首选，这里是快速进入 Defi 的通道。
...
- 你可以在以下网址查看当前策略[feel-the-yearn](https://feel-the-yearn.app)
- 未来我们将制作导航页让机枪池策略和年化收益更简单易懂

**谁在控制机枪池策略？**

- 机枪池策略為 Andre 所写，但是必須通过多重签名来决定是否可以实施策略。
...
- 大致过程为：
  ...
  2.升级到 yip（通常由 mods 完成），添加到社区提案的 github，放到链接上。

  3.提案公布

#### 谁可以发起提案？

- 任何人都可以在 forum 链上发起提案。
...
- 你仅需要将 YFI 质押到 [ygov.finance/stake](https://ygov.finance/stake)，在国库账户 50 万 usd 之外的收益都会奖励给投票账户。[国库的地址为](https://zapper.fi/dashboard?address=0xFEB4acf3df3cDEA7399794D0869ef76A6EfAff52).
- 如果将 YFI 进行质押投票操作（只要不进入国库地址），你需要在投票 的 3 天后才可以提取收益。

#### 社区投票需要质押 YFI 吗？

是的你必须质押你的 YFI 到 v2 版本的才可以获得有效投票权，质押地址为[ygov.finance/stake](https://ygov.finance/stake) 。你也可以不质押投票，但这只会浪费 gas 费用，因此投票前必须质押。

#### 可以在投票锁定期尚未结束时拿走 yfi 吗？

- 不可以。在你最近一次投票后需要锁定 3 天，期间 yfi 不能解除质押。

#### 我已经投票，并且我知道要锁定 3 天，在哪里可以查看确切的解锁 YFI 时间？

- 是的，你可以直接进入到质押投票的合约\([https://etherscan.io/address/0xBa37B002AbaFDd8E89a1995dA52740bbC013D992\#readContract](https://etherscan.io/address/0xBa37B002AbaFDd8E89a1995dA52740bbC013D992#readContrac)\)，直接到合约的第 28 项，输入地址，这里会反馈给你一个 eth 的出块数，到达出块数后你就可以解除质押。
...
- 首先点击网页[Pokemol](https://pokemol.com/dao/0xcb46298767fb5d44c18313976c30d3eeb5071862) ，使用 web3 账户介入，点击右上角新提案按钮，点击会员。
  ...
  - 请求的股份：请求的股份数- Token Tribute: 你贡献 YFI 的金额 \(你将需要解锁 YFI\)
  - 代币捐赠：认捐的 YFI 数量（您需要解锁 YFI）- Loot: 要求的股份的数量
  - 股份：请求的股份数量
  - 提交两项交易并进入新的成员队列后，您将需要一个支持者。请复制链接到您的提案，让我们知道您想加入[yDAO 电报频道](https://t.me/joinchat/Qn1GPBv0y7lY1vAmRCB7KA)

#### 如何申请资金？

- 与加入方式相同，除了点击成员以外，点击资金标签，然后填写您的请求详细信息。如果您有任何疑问，可以在\[电报聊天\] \([中询问](https://t.me/joinchat/Qn1GPBv0y7lY1vAmRCB7KA)\)
...
- 多重签名的地址详细内容可以点击[网站](https://gov.yearn.finance/t/yfi-minting-ownership/155%29)找到。他主要是控制 YFI 的铸造，签名生效需要 9 个人中的 6 个人签名。
...
- [yLINK 币](https://etherscan.io/address/0x881b06da56bb5675c54e4ed311c21e54c5025298#code)
- [yaLINK 币](https://etherscan.io/address/0x29e240cfd7946ba20895a7a02edb25c210f9f324#readContract)
...
- [USDC 为 LINK 的策略](https://etherscan.io/address/0x25fAcA21dd2Ad7eDB3a027d543e617496820d8d6)
- [USDC 库的策略](https://etherscan.io/address/0xA30d1D98C502378ad61Fe71BcDc3a808CF60b897)
- [DAI 库](https://etherscan.io/address/0xACd43E627e64355f1861cEC6d3a6688B31a6F952)
...
- 可以在 discord 的[#media-resources](https://discord.com/channels/734804446353031319/736132884443955242/740325105904779326)频道找到
